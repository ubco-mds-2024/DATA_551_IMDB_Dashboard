...
df = df[['Title', 'Year', 'Duration', 'Rating', 'budget', 'grossWorldWide', 'gross_US_Canada', 'opening_weekend_Gross',
         'directors', 'writers', 'stars', 'genres']]
...
app.layout = dbc.Container([
    ...
    dbc.Row([
        ...
        dbc.Col([
            html.H5("Histogram"),
            dcc.Dropdown(id='hist-x-widget', value='Rating', options=[{'label': col, 'value': col} for col in
                                                                      df.select_dtypes(
    ...
    dbc.Row([
        dbc.Col([
            html.H5("Bar Chart"),
            dcc.Dropdown(id='bar-x-widget', value='grossWorldWide', options=[{'label': col, 'value': col} for col in
        ...
        dbc.Col([
            html.H5("Box Plot"),
            dcc.Dropdown(id='box-x-widget', value='budget', options=[{'label': col, 'value': col} for col in
                                                                     df.select_dtypes(
                                                                         include=['int64', 'float64']).columns]),
        ...
        dbc.Col([
            html.H5("Pie Chart"),
            dcc.Dropdown(id='pie-x-widget', value='wins', options=[{'label': col, 'value': col} for col in
                                                                   df.select_dtypes(
                                                                       include=['int64', 'float64']).columns]),
            ...
            dbc.Container([
                ...
                dbc.Row([
                    dbc.Col([
                        ...
                        html.Br(), html.Br(),
                        html.Iframe(id='stats-bar-chart',
